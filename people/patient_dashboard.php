...
-->
	...
	<br>
		...
		<form action="addMembersSignup.inc.php" method="post" enctype="multipart/form-data" id="registerForm" style="display: none;">
	...
	/*
		...
		echo "<button onclick='selectPerson()'>Current user</button>";
		if($numUsers == 2){
			echo "<br>
					<button onclick='selectPerson()'>Person 2</button>
				<br>
					<button onclick='selectPerson()'>Combined</button>
				<br>";
		}
		*/
	?>
	
	<div id="bookingAppointment"  style="display: none;">
	<br>
	<br>
	<div>
...
/*		/*
			...
			if($row_vaccine['curr_covaccine'] > 0){
				$_SESSION['day'] = 1;
				#echo "<br>Covaxin Count: ".$row_vaccine['curr_covaccine'];
				echo "<input type='submit' value='covaxin' name='covaxin'>";
			}	
			else{
				echo "Covaxin Not available!";
			}
			if($row_vaccine['curr_covisheild'] > 0){
				#echo "<br>Covishield Count: ".$row_vaccine['curr_covisheild'];
				echo "<input type='submit' value='covishield' name='covishield'>";
			}
			else{
				echo "Covishield Not available!";
			}
